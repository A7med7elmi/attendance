        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form class="form-horizontal" method="POST" action="employee_add.php" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        <label for="thepassword" class="col-sm-3 control-label">Password</label>

                        <div class="col-sm-9">
                            <input type="password" class="form-control" id="thepassword" name="thepassword" required>
                        </div>
                    </div>
                    <div class="form-group">
            ...
            <div class="modal-body">
                <form class="form-horizontal" method="POST" action="employee_edit.php">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <input type="password" class="form-control" id="edit_thepassword" name="thepassword" required>
                        </div>
                    </div>
                    <div class="form-group">
