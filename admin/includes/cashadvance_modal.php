            ...
            <div class="modal-body">
                <form class="form-horizontal" method="POST" action="cashadvance_add.php">
                    <div class="form-group">
                        <label for="employee" class="col-sm-3 control-label">Employee Code</label>
                        <div class="col-sm-9">
                    ...
                    <div class="form-group">
                        <label for="deduction" class="col-sm-3 control-label">Monthly Deduction </label>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form class="form-horizontal" method="POST" action="cashadvance_edit.php">
                    ...
                    <div class="form-group">
                        <label for="edit_deduction" class="col-sm-3 control-label">Monthly Deduction </label>

                        <div class="col-sm-9">
                            <input type="text" class="form-control" id="edit_deduction" name="deduction" required>
                        </div>
                    </div>
            </div>
            <div class="modal-footer">
