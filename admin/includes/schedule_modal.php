        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form class="form-horizontal" method="POST" action="schedule_add.php">
                    ...
                    <div class="form-group">
                        <label for="time_break_from" class="col-sm-3 control-label">Break From</label>
                        <div class="col-sm-9">
                            <div class="bootstrap-timepicker">
                                <input type="text" class="form-control timepicker" id="time_break_from" name="time_break_from" required>
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="time_break_to" class="col-sm-3 control-label">Break To</label>
                        <div class="col-sm-9">
                            <div class="bootstrap-timepicker">
                                <input type="text" class="form-control timepicker" id="time_break_to" name="time_break_to" required>
                            </div>
                        </div>
                    </div>
            </div>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form class="form-horizontal" method="POST" action="schedule_edit.php">
                    ...
                    <div class="form-group">
                        <label for="edit_time_break_from" class="col-sm-3 control-label">Break From</label>
                        <div class="col-sm-9">
                            <div class="bootstrap-timepicker">
                                <input type="text" class="form-control timepicker" id="edit_time_break_from" name="time_break_from" required>
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="edit_time_break_to" class="col-sm-3 control-label">Break To</label>
                        <div class="col-sm-9">
                            <div class="bootstrap-timepicker">
                                <input type="text" class="form-control timepicker" id="edit_time_break_to" name="time_break_to" required>
                            </div>
                        </div>
                    </div>
            </div>
