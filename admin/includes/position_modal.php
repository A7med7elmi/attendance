        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form class="form-horizontal" method="POST" action="position_add.php">
                    ...
                    <div class="form-group">
                        <label for="rate_overtime" class="col-sm-3 control-label">Overtime Rate per Hr</label>

                        <div class="col-sm-9">
                            <input type="text" class="form-control" id="rate_overtime" name="rate_overtime" required>
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="rate_deduction" class="col-sm-3 control-label">Deduct Rate per Hr</label>

                        <div class="col-sm-9">
                            <input type="text" class="form-control" id="rate_deduction" name="rate_deduction" required>
                        </div>
                    </div>
            </div>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form class="form-horizontal" method="POST" action="position_edit.php">
                    ...
                    <div class="form-group">
                        <label for="edit_rate_overtime" class="col-sm-3 control-label">Overtime Rate per Hr</label>

                        <div class="col-sm-9">
                            <input type="text" class="form-control" id="edit_rate_overtime" name="rate_overtime" required>
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="edit_rate_deduction" class="col-sm-3 control-label">Deduct Rate per Hr</label>

                        <div class="col-sm-9">
                            <input type="text" class="form-control" id="edit_rate_deduction" name="rate_deduction" required>
                        </div>
                    </div>
            </div>
            <div class="modal-footer">
